...
const PATTERNS: [RegExp, string][] = [
  ...
  // Minerals are written many ways: "Magnesium (from …)", "Elemental magnesium from a
  // magnesium bisglycinate blend", "Fully reacted magnesium orotate". Match the element
  // anywhere in the name; the vitamin patterns above already claimed "calcium ascorbate",
  // "calcium pantothenate" and "calcium ʟ-5-methyltetrahydrofolate".
  [/\biod(?:ine|ide)\b/i, 'iodine'],
  [/\biron\b/i, 'iron'],
  ...
  [/\bmolybdenum\b/i, 'molybdenum'],
  [/\bpotassium\b/i, 'potassium'],
  [/\bboron\b/i, 'boron'],
  [/\bsilic(?:on|a)\b/i, 'silicon'],
  [/^choline\b/i, 'choline'],
